...
//Name: 2D_puppet_test.ma
//Last modified: Fri, Feb 08, 2019 02:53:27 PM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.26442742246790096 5.5225465034277539 4.6539510042246226 ;
	setAttr ".r" -type "double3" -11.738352729644117 -9.8000000000041734 2.017283075337587e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "D4CE8D5B-A84E-F64D-EA67-12A1178C10C2";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 1.8554236815348946;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0.08957132901526757 5.0940514943277533 2.882334305301788 ;
...
createNode transform -n "puppet01_grp";
	...
	setAttr ".t" -type "double3" 0 5.205 2.585 ;
...
createNode mesh -n "r_eyeShape" -p "r_eye";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.50303928554058075 0.7751239538192749 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr -s 4 ".uvst[0].uvsp[0:3]" -type "float2" 0.49374285 0.7578541
		 0.49374285 0.7923938 0.51233572 0.7578541 0.51233572 0.7923938;
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "3E856357-8B48-38B1-509F-4794287922DA";
	setAttr -s 140 ".lnk";
	setAttr -s 140 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "48418954-4C4F-BAA4-1D5B-B2B933CA2185";
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
createNode displayLayer -n "defaultLayer";
	rename -uid "DA19802F-8D4E-88C3-DCE8-1E96FB7AC527";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "668299B6-9C4F-6500-B932-038343389B2B";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "8B31AC33-A743-4808-B6EA-F6A35256BBC0";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "5DB3D104-CE46-7811-DF85-BAA47E7E0CB5";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "DD127560-044A-A4AE-64FA-9A878554E60C";
createNode reference -n "xRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translateX" " 3.55220566669579307"
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "D2D80AE3-B244-B509-4DB7-88A4BE9207F5";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 980.48465047905245 -2598.4586466134542 ;
	setAttr ".tgi[0].vh" -type "double2" 4014.33828658517 1929.5963121441778 ;
	setAttr -s 32 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 2302.857177734375;
	setAttr ".tgi[0].ni[0].y" 227.75605773925781;
	setAttr ".tgi[0].ni[0].nvs" 1923;
	setAttr ".tgi[0].ni[1].x" 1638.5714111328125;
	setAttr ".tgi[0].ni[1].y" 100;
	setAttr ".tgi[0].ni[1].nvs" 1923;
	setAttr ".tgi[0].ni[2].x" 2577.142822265625;
	setAttr ".tgi[0].ni[2].y" -1902.857177734375;
	setAttr ".tgi[0].ni[2].nvs" 1923;
	setAttr ".tgi[0].ni[3].x" 1911.4285888671875;
	setAttr ".tgi[0].ni[3].y" -1678.5714111328125;
	setAttr ".tgi[0].ni[3].nvs" 1923;
	setAttr ".tgi[0].ni[4].x" 1604.2857666015625;
	setAttr ".tgi[0].ni[4].y" -1700;
	setAttr ".tgi[0].ni[4].nvs" 1923;
	setAttr ".tgi[0].ni[5].x" 1604.2857666015625;
	setAttr ".tgi[0].ni[5].y" -482.85714721679688;
	setAttr ".tgi[0].ni[5].nvs" 1923;
	setAttr ".tgi[0].ni[6].x" 1607.142822265625;
	setAttr ".tgi[0].ni[6].y" -1121.4285888671875;
	setAttr ".tgi[0].ni[6].nvs" 1923;
	setAttr ".tgi[0].ni[7].x" 2312.1884765625;
	setAttr ".tgi[0].ni[7].y" 701.4285888671875;
	setAttr ".tgi[0].ni[7].nvs" 1923;
	setAttr ".tgi[0].ni[8].x" 2577.142822265625;
	setAttr ".tgi[0].ni[8].y" -717.14288330078125;
	setAttr ".tgi[0].ni[8].nvs" 1923;
	setAttr ".tgi[0].ni[9].x" 1945.7142333984375;
	...
	setAttr ".tgi[0].ni[11].x" 1911.4285888671875;
	setAttr ".tgi[0].ni[11].y" -1987.142822265625;
	setAttr ".tgi[0].ni[11].nvs" 1923;
	setAttr ".tgi[0].ni[12].x" 2270;
	setAttr ".tgi[0].ni[12].y" -1572.857177734375;
	setAttr ".tgi[0].ni[12].nvs" 1923;
	setAttr ".tgi[0].ni[13].x" 2574.28564453125;
	setAttr ".tgi[0].ni[13].y" -995.71429443359375;
	setAttr ".tgi[0].ni[13].nvs" 1923;
	setAttr ".tgi[0].ni[14].x" 2270;
	setAttr ".tgi[0].ni[14].y" -357.14285278320312;
	setAttr ".tgi[0].ni[14].nvs" 1923;
	setAttr ".tgi[0].ni[15].x" 2574.28564453125;
	setAttr ".tgi[0].ni[15].y" -1314.2857666015625;
	setAttr ".tgi[0].ni[15].nvs" 1923;
	setAttr ".tgi[0].ni[16].x" 2267.142822265625;
	setAttr ".tgi[0].ni[16].y" -1292.857177734375;
	setAttr ".tgi[0].ni[16].nvs" 1923;
	setAttr ".tgi[0].ni[17].x" 2270;
	setAttr ".tgi[0].ni[17].y" -1882.857177734375;
	setAttr ".tgi[0].ni[17].nvs" 1923;
	setAttr ".tgi[0].ni[18].x" 2267.142822265625;
	setAttr ".tgi[0].ni[18].y" -994.28570556640625;
	setAttr ".tgi[0].ni[18].nvs" 1923;
	setAttr ".tgi[0].ni[19].x" 1911.4285888671875;
	setAttr ".tgi[0].ni[19].y" -462.85714721679688;
	setAttr ".tgi[0].ni[19].nvs" 1923;
	setAttr ".tgi[0].ni[20].x" 1914.2857666015625;
	setAttr ".tgi[0].ni[20].y" -1397.142822265625;
	setAttr ".tgi[0].ni[20].nvs" 1923;
	setAttr ".tgi[0].ni[21].x" 1914.2857666015625;
	setAttr ".tgi[0].ni[21].y" -1100;
	setAttr ".tgi[0].ni[21].nvs" 1923;
	setAttr ".tgi[0].ni[22].x" 1607.142822265625;
	setAttr ".tgi[0].ni[22].y" -1418.5714111328125;
	setAttr ".tgi[0].ni[22].nvs" 1923;
	setAttr ".tgi[0].ni[23].x" 1951.4285888671875;
	setAttr ".tgi[0].ni[23].y" 597.14288330078125;
	setAttr ".tgi[0].ni[23].nvs" 1923;
	setAttr ".tgi[0].ni[24].x" 2615.71435546875;
	setAttr ".tgi[0].ni[24].y" 681.4285888671875;
	setAttr ".tgi[0].ni[24].nvs" 1923;
	setAttr ".tgi[0].ni[25].x" 2270;
	setAttr ".tgi[0].ni[25].y" -695.71429443359375;
	setAttr ".tgi[0].ni[25].nvs" 1923;
	setAttr ".tgi[0].ni[26].x" 1644.2857666015625;
	setAttr ".tgi[0].ni[26].y" 575.71429443359375;
	setAttr ".tgi[0].ni[26].nvs" 1923;
	setAttr ".tgi[0].ni[27].x" 2577.142822265625;
	setAttr ".tgi[0].ni[27].y" -377.14285278320312;
	setAttr ".tgi[0].ni[27].nvs" 1923;
	setAttr ".tgi[0].ni[28].x" 1604.2857666015625;
	setAttr ".tgi[0].ni[28].y" -821.4285888671875;
	setAttr ".tgi[0].ni[28].nvs" 1923;
	setAttr ".tgi[0].ni[29].x" 1911.4285888671875;
	setAttr ".tgi[0].ni[29].y" -800;
	setAttr ".tgi[0].ni[29].nvs" 1923;
	setAttr ".tgi[0].ni[30].x" 2610;
	setAttr ".tgi[0].ni[30].y" 205.71427917480469;
	setAttr ".tgi[0].ni[30].nvs" 1923;
	setAttr ".tgi[0].ni[31].x" 2577.142822265625;
	setAttr ".tgi[0].ni[31].y" -1594.2857666015625;
...
select -ne :defaultRenderGlobals;
	...
	setAttr ".pff" yes;
	setAttr ".peie" 0;
	setAttr ".ifp" -type "string" "/vic_boy01_handwave/vic_boy01_handwave_";
...
connectAttr "r_eyeShape.iog" "r_eye_matSG.dsm" -na;
connectAttr "l_eyeShape.iog" "r_eye_matSG.dsm" -na;
...
connectAttr "l_arm_mat.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "place2dTexture6.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[1].dn"
		;
connectAttr "r_eye_matSG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
connectAttr "file10.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
connectAttr "place2dTexture10.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
connectAttr "place2dTexture8.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[5].dn"
		;
connectAttr "place2dTexture12.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[6].dn"
		;
connectAttr "r_arm_mat.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[7].dn"
		;
connectAttr "r_leg_matSG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[8].dn"
		;
connectAttr "file6.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[9].dn"
		;
connectAttr "place2dTexture11.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[10].dn"
		;
connectAttr "file11.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[11].dn"
		;
connectAttr "l_eye_mat.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[12].dn"
		;
connectAttr "r_foot_matSG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[13].dn"
		;
connectAttr "l_leg_mat.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[14].dn"
		;
connectAttr "l_foot_matSG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[15].dn"
		;
connectAttr "l_foot_mat.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[16].dn"
		;
connectAttr "r_eye_mat.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[17].dn"
		;
connectAttr "r_foot_mat.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[18].dn"
		;
...
connectAttr "file7.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[23].dn"
		;
connectAttr "r_arm_matSG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[24].dn"
		;
connectAttr "r_leg_mat.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[25].dn"
		;
connectAttr "place2dTexture7.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[26].dn"
		;
connectAttr "l_leg_matSG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[27].dn"
		;
connectAttr "place2dTexture9.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[28].dn"
		;
connectAttr "file9.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[29].dn"
		;
connectAttr "l_arm_matSG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[30].dn"
		;
connectAttr "l_eye_matSG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[31].dn"
		;
