...
//Name: eye_calibration_03.ma
//Last modified: Tue, Mar 06, 2018 02:46:33 PM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -5.1207882488114729 17.026385384488602 17.788431251336558 ;
	setAttr ".r" -type "double3" -34.538352729602479 -15.000000000000009 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "D92FAF17-0841-306D-D78D-139F3BC48CB5";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 24.018591740318637;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "2630BCD7-4B4A-03DD-8C83-A19BA641F687";
	setAttr -s 130 ".lnk";
	setAttr -s 130 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "E91CC235-6746-78E5-DD71-7B9539A48DAF";
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
createNode displayLayer -n "defaultLayer";
	rename -uid "789479B6-6247-9F9C-D566-01B6BAAC2CA7";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "BDA4D068-BC43-2BA7-106B-9DB95ED59FEA";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "1946459A-BE40-10F7-05C2-BFA6867F02AE";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "4DA8E50E-5A4E-0FBA-A82C-45A5DC2C7613";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "17EFEDB5-4644-923E-794B-358591DF5585";
...
createNode animCurveTL -n "mech_lwrLid_L_ctrl_translateX";
	...
	setAttr ".tan" 1;
	setAttr ".ktv[0]"  0 5.4385242937875642e-32;
	setAttr ".kix[0]"  0.033333333333333215;
	setAttr ".kiy[0]"  0;
	setAttr ".kox[0]"  8.3;
	setAttr ".koy[0]"  0;
...
createNode gameFbxExporter -n "gameExporterPreset2";
	...
	setAttr ".ilu" yes;
	setAttr ".eti" 2;
	setAttr ".ac[0].acn" -type "string" "default_eyes_adjustment";
