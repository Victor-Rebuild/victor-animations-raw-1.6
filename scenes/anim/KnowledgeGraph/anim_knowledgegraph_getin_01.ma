...
//Name: anim_knowledgegraph_getin_01.ma
//Last modified: Tue, Feb 19, 2019 02:45:24 PM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -25.99326674562699 27.309622233285126 24.239113378297436 ;
	setAttr ".r" -type "double3" -37.538352729602494 -47 2.3317905641093104e-15 ;
...
createNode transform -n "x:AnkiAudioNode";
	rename -uid "0DB925FC-9244-4611-25D7-339B653B52F8";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "0D9C2C99-2849-0BD5-BDEA-B988C775AEE1";
	setAttr -s 130 ".lnk";
	setAttr -s 130 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "42B3B05A-B544-58B0-04FE-4C9B4CDFF093";
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
createNode displayLayer -n "defaultLayer";
	rename -uid "330872FD-3049-6458-B240-C381631B9530";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "24ECC599-F146-AFB7-67F1-BB819508DB57";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "5C59E4E0-F64F-D8F6-97B4-BFB667A59F5F";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "7D025993-724D-5BB4-F103-DB90B823CD03";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "D2823A5F-6244-A70B-D81D-A69ABDE7178B";
...
createNode reference -n "xRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		" -cb 1 -type \"string\" \"face_knowledgegraph_getin\""
		2 "|x:actor_grp|x:ctrl_grp|x:virtual_all_ctrl|x:movement_grp|x:all_subDriver_null|x:virtual_all_sub_ctrl|x:null1_grp|x:virtual_head_ctrl|x:mech_head_ctrl" 
		"rotateX" " -av 0.014778443648429892"
		2 "|x:actor_grp|x:ctrl_grp|x:virtual_all_ctrl|x:movement_grp|x:all_subDriver_null|x:virtual_all_sub_ctrl|x:null1_grp|x:virtual_arm_ctrl|x:mech_arm_ctrl" 
		"rotateX" " -av 0"
		2 "|x:actor_grp|x:ctrl_grp|x:virtual_all_ctrl|x:movement_grp|x:all_subDriver_null|x:virtual_all_sub_ctrl|x:wheel_R_ctrl" 
		"rotateX" " -av -8.38355621825100883"
...
createNode gameFbxExporter -n "gameExporterPreset2";
	...
	setAttr ".ilu" yes;
	setAttr ".eti" 2;
	setAttr ".ac[0].acn" -type "string" "anim_knowledgegraph_getin_01";
	setAttr ".ac[0].ace" 25;
	setAttr ".spt" 2;
	setAttr ".ic" no;
	setAttr ".ebm" yes;
...
createNode animCurveTU -n "eyeCorner_L_OuterBtm_ctrl_scaleX";
	...
	setAttr ".tan" 18;
	setAttr -s 3 ".ktv[0:2]"  0 1 5 1 29 1;
...
createNode animCurveTL -n "mech_L_pupil_ctrl_translateX";
	...
	setAttr ".tan" 18;
	setAttr -s 3 ".ktv[0:2]"  0 0 5 0 29 0;
...
createNode animCurveTA -n "mech_arm_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr -s 6 ".ktv[0:5]"  0 0 5 0 9 0 11 -3.9757299850232761 13 0
		 29 0;
...
createNode animCurveTA -n "mech_head_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr -s 5 ".ktv[0:4]"  0 -4.0535123195311211 5 -4.0535123195311211
		 9 0.014778443648429892 15 -35 39 -35;
...
createNode animCurveTL -n "treads_L_lwr_ctrl_translateX";
	...
	setAttr -s 3 ".ktv[0:2]"  0 0.044676191985453695 5 0.044676191985453695
		 29 0.044676191985453695;
createNode animCurveTL -n "treads_L_lwr_ctrl_translateY";
	rename -uid "079E43E7-6B4C-2308-4E70-89AA1FDE0FB4";
	setAttr ".tan" 18;
	setAttr -s 3 ".ktv[0:2]"  0 -4.4408920985006262e-16 5 -4.4408920985006262e-16
		 29 -4.4408920985006262e-16;
createNode animCurveTL -n "treads_L_lwr_ctrl_translateZ";
	rename -uid "0BFB3B40-604A-3A85-F183-78B0B791FA20";
	setAttr ".tan" 18;
	setAttr -s 3 ".ktv[0:2]"  0 -1.0842021724855044e-19 5 -1.0842021724855044e-19
		 29 -1.0842021724855044e-19;
...
createNode animCurveTA -n "wheel_L_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr -s 4 ".ktv[0:3]"  0 0 7 0 9 -8.3835562182510088 13 21.016494295928624;
createNode animCurveTA -n "wheel_R_ctrl_rotateX";
	rename -uid "B0FC2C92-044D-2D15-6C57-65A739664F35";
	setAttr ".tan" 18;
	setAttr -s 4 ".ktv[0:3]"  0 0 7 0 9 -8.3835562182510088 13 21.016494295928624;
createNode animCurveTU -n "AnkiAudioNode_WwiseIdEnum";
	rename -uid "92E96C74-654D-ED5C-C74F-E78B0F0BBC21";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  8 175;
	setAttr ".kot[0]"  5;
createNode animCurveTU -n "AnkiAudioNode_volume";
	rename -uid "4B025C9F-BF4A-5192-A988-1DAF3D092DE8";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 100;
	setAttr ".kot[0]"  5;
createNode animCurveTU -n "AnkiAudioNode_probability";
	rename -uid "20DA8EAA-B942-43FA-746A-18B693B83010";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 100;
	setAttr ".kot[0]"  5;
createNode animCurveTU -n "AnkiAudioNode_hasAlts";
	rename -uid "40A0D467-FA4C-63B7-5EE2-66A96B365FB9";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 1;
	setAttr ".kot[0]"  5;
createNode animCurveTU -n "backpack_ctrl_frontRed1";
	rename -uid "D5E3F0B5-2C44-C068-9179-37886AF4A953";
	setAttr ".tan" 18;
	setAttr ".ktv[0]"  0 0;
createNode animCurveTU -n "backpack_ctrl_frontGreen1";
	rename -uid "F5D41898-9747-1AE8-2D89-3D98EFE51FCC";
	setAttr ".tan" 18;
	setAttr ".ktv[0]"  0 0;
createNode animCurveTU -n "backpack_ctrl_frontBlue1";
	rename -uid "E9693452-0D4F-BC4B-14E5-388FD5307E9D";
	setAttr ".tan" 18;
	setAttr ".ktv[0]"  0 0;
createNode animCurveTU -n "backpack_ctrl_middleRed1";
	rename -uid "B0827EA5-F645-9D0F-A84F-B9BCE9F9BA68";
	setAttr ".tan" 18;
	setAttr ".ktv[0]"  0 0;
createNode animCurveTU -n "backpack_ctrl_middleGreen1";
	rename -uid "006B062A-2445-E200-E9D3-AB9E4B778B67";
	setAttr ".tan" 18;
	setAttr ".ktv[0]"  0 0;
createNode animCurveTU -n "backpack_ctrl_middleBlue1";
	rename -uid "5402408E-3D49-F8CB-E53B-F5A15AF4DEAB";
	setAttr ".tan" 18;
	setAttr ".ktv[0]"  0 0;
createNode animCurveTU -n "backpack_ctrl_backRed1";
	rename -uid "4D21C583-8F44-BCFB-7DD6-98A71D26508D";
	setAttr ".tan" 18;
	setAttr ".ktv[0]"  0 0;
createNode animCurveTU -n "backpack_ctrl_backGreen1";
	rename -uid "32E2BCA2-1640-8D92-AF0A-658CA62228CA";
	setAttr ".tan" 18;
	setAttr ".ktv[0]"  0 0;
createNode animCurveTU -n "backpack_ctrl_backBlue1";
	rename -uid "2ECC71F9-0748-F004-2DA6-EDB1B30F3B1D";
	setAttr ".tan" 18;
	setAttr ".ktv[0]"  0 0;
createNode animCurveTU -n "AnkiAudioNode_WwiseIdEnum1";
	rename -uid "CB1E4B11-0D48-8724-8DEE-C0887B98BFEE";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 180 8 190;
	setAttr -s 2 ".kot[0:1]"  5 5;
createNode animCurveTU -n "AnkiAudioNode_WwiseIdEnum2";
	rename -uid "513AB5BB-4547-AA3E-037A-7C93F0A3453F";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 151;
	setAttr ".kot[0]"  5;
createNode objectSet -n "selected_controllers_set";
	rename -uid "B4D0A194-7048-E840-96A1-3B9BF2A7DE51";
	setAttr ".ihi" 0;
select -ne :time1;
	setAttr -av -k on ".cch";
...
connectAttr "backpack_ctrl_frontRed1.o" "xRN.phl[75]";
connectAttr "backpack_ctrl_frontGreen1.o" "xRN.phl[76]";
connectAttr "backpack_ctrl_frontBlue1.o" "xRN.phl[77]";
connectAttr "backpack_ctrl_middleRed1.o" "xRN.phl[78]";
connectAttr "backpack_ctrl_middleGreen1.o" "xRN.phl[79]";
connectAttr "backpack_ctrl_middleBlue1.o" "xRN.phl[80]";
connectAttr "backpack_ctrl_backRed1.o" "xRN.phl[81]";
connectAttr "backpack_ctrl_backGreen1.o" "xRN.phl[82]";
connectAttr "backpack_ctrl_backBlue1.o" "xRN.phl[83]";
...
// End of anim_knowledgegraph_getin_01.ma
