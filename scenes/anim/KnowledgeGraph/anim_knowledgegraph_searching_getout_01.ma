...
//Name: anim_knowledgegraph_searching_getout_01.ma
//Last modified: Mon, Jul 16, 2018 02:22:27 PM
//Codeset: UTF-8
...
createNode transform -n "x:AnkiAudioNode";
	rename -uid "B56E0EAA-4D4A-4DF4-2ED4-5C86D362A241";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "EBCE39D7-9A45-3AFB-AA20-AAA82F3E610A";
	setAttr -s 130 ".lnk";
	setAttr -s 130 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "6E5B9953-D041-A491-7C2C-059816082733";
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
createNode displayLayer -n "defaultLayer";
	rename -uid "330872FD-3049-6458-B240-C381631B9530";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "4E1872A0-E745-222A-5EE9-EAAFDF6C580A";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "5C59E4E0-F64F-D8F6-97B4-BFB667A59F5F";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "88A92CEB-8E49-848B-1F6F-F4902E22C04E";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "3C5CF176-D74F-C262-D43D-61BDA57579F8";
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 0 -max 26 -ast 0 -aet 250 ";
	setAttr ".st" 6;
createNode reference -n "xRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		" -cb 1 -type \"string\" \"face_knowledgegraph_searching_getout\""
...
createNode gameFbxExporter -n "gameExporterPreset2";
	...
	setAttr ".ilu" yes;
	setAttr ".eti" 2;
	setAttr ".ac[0].acn" -type "string" "anim_knowledgegraph_searching_getout_01";
	setAttr ".ac[0].ace" 26;
	setAttr ".spt" 2;
	setAttr ".ic" no;
	setAttr ".ebm" yes;
...
createNode animCurveTL -n "mech_eye_L_ctrl_translateX";
	...
	setAttr ".tan" 18;
	setAttr -s 3 ".ktv[0:2]"  5 0 8 0.005 29 0;
...
createNode animCurveTA -n "mech_head_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr -s 4 ".ktv[0:3]"  0 -35 2 -21.158636696320855 8 -35 29 -35;
...
createNode animCurveTA -n "wheel_L_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr -s 5 ".ktv[0:4]"  1 0 3 -11.953314035156568 7 19.973908256097886
		 9 8.2613041830715623 25 8.2613041830715623;
...
createNode animCurveTU -n "AnkiAudioNode_WwiseIdEnum";
	rename -uid "BF0C9F4D-EB46-0A4A-395D-F18860A35340";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  0 192;
	setAttr ".kot[0]"  5;
createNode animCurveTU -n "AnkiAudioNode_volume";
	rename -uid "5DD740BB-E544-8534-F625-458F052DDEB5";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 100 1 100;
	setAttr -s 2 ".kot[0:1]"  5 5;
createNode animCurveTU -n "AnkiAudioNode_probability";
	rename -uid "B7B63BBB-8842-5A65-A5D0-DE880BABC8E5";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 100 1 100;
	setAttr -s 2 ".kot[0:1]"  5 5;
createNode animCurveTU -n "AnkiAudioNode_hasAlts";
	rename -uid "36E97A6D-184C-F660-2F17-388D65985FB5";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 1 1 1;
	setAttr -s 2 ".kot[0:1]"  5 5;
createNode animCurveTU -n "AnkiAudioNode_WwiseIdEnum1";
	rename -uid "8719C3E2-FA40-C406-CABF-8E9798A45D7E";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 749 1 193;
	setAttr -s 2 ".kot[0:1]"  5 5;
createNode objectSet -n "selected_controllers_set";
	rename -uid "CFD37EFF-DF4C-D5ED-FA1C-1F83D2FE32AC";
	setAttr ".ihi" 0;
select -ne :time1;
	setAttr -av -k on ".cch";
...
// End of anim_knowledgegraph_searching_getout_01.ma
