...
//Name: anim_knowledgegraph_searching_getin_01.ma
//Last modified: Fri, Jun 29, 2018 03:33:21 PM
//Codeset: UTF-8
...
createNode transform -n "x:AnkiAudioNode";
	rename -uid "0D63CC65-DA47-D949-D2B0-2691EB0ABC0A";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "35829EB0-B64E-DAB4-8960-0D92F4783875";
	setAttr -s 130 ".lnk";
	setAttr -s 130 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "D2265617-674F-9E74-516C-BDA760A65DAE";
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
createNode displayLayer -n "defaultLayer";
	rename -uid "330872FD-3049-6458-B240-C381631B9530";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "F0580D6C-EA45-BCA1-2A81-33ACECA38254";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "5C59E4E0-F64F-D8F6-97B4-BFB667A59F5F";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "03DBAFC9-0045-FDE6-A312-4CA92B4B1AF4";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "C15FE411-CF47-EABC-11AD-82ACCC27DCA4";
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 0 -max 8 -ast 0 -aet 250 ";
	setAttr ".st" 6;
createNode reference -n "xRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		" -cb 1 -type \"string\" \"face_knowledgegraph_searching_getin\""
		...
		"rotateX" " -av 5.49153217680412098"
...
createNode gameFbxExporter -n "gameExporterPreset2";
	...
	setAttr ".ilu" yes;
	setAttr ".eti" 2;
	setAttr ".ac[0].acn" -type "string" "anim_knowledgegraph_searching_getin_01";
	setAttr ".ac[0].ace" 8;
	setAttr ".spt" 2;
	setAttr ".ic" no;
	setAttr ".ebm" yes;
...
createNode animCurveTA -n "mech_arm_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr -s 4 ".ktv[0:3]"  3 0 5 -5.8783606490427252 7 0 29 0;
...
createNode animCurveTA -n "mech_head_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr -s 5 ".ktv[0:4]"  0 -35 1 -35 3 -25.250369451420433 8 -35
		 29 -35;
...
createNode animCurveTA -n "wheel_L_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr -s 4 ".ktv[0:3]"  0 0 2 0 6 16.411631380868453 8 5.491532176804121;
...
createNode animCurveTU -n "AnkiAudioNode_WwiseIdEnum";
	rename -uid "5C555F98-8C49-0291-4E7A-21BFD62FFF20";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  0 194;
	setAttr ".kot[0]"  5;
createNode animCurveTU -n "AnkiAudioNode_volume";
	rename -uid "B10C05B4-2F40-51F8-F615-45B70E5ECBA2";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  0 100;
	setAttr ".kot[0]"  5;
createNode animCurveTU -n "AnkiAudioNode_probability";
	rename -uid "BF6BDC9A-1C46-93FE-C9EF-60AA3F947E22";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  0 100;
	setAttr ".kot[0]"  5;
createNode animCurveTU -n "AnkiAudioNode_hasAlts";
	rename -uid "878EA3AE-7E48-3D8E-174B-F9BDD6C7B852";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  0 1;
	setAttr ".kot[0]"  5;
...
// End of anim_knowledgegraph_searching_getin_01.ma
