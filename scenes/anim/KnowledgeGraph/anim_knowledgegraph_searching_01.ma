...
//Name: anim_knowledgegraph_searching_01.ma
//Last modified: Fri, Jul 13, 2018 11:30:40 AM
//Codeset: UTF-8
...
createNode transform -n "x:AnkiAudioNode";
	rename -uid "3497FFCA-3F49-BFA3-8099-6FA44F9BEAC1";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "81B954FC-1D49-EE5D-6DCC-A39ADBA40ABA";
	setAttr -s 130 ".lnk";
	setAttr -s 130 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "750D366D-924B-D53D-36D4-B9A25E6D6418";
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
createNode displayLayer -n "defaultLayer";
	rename -uid "330872FD-3049-6458-B240-C381631B9530";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "1482A5AF-F843-1F2D-DDD2-3E96D04FF8DE";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "5C59E4E0-F64F-D8F6-97B4-BFB667A59F5F";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "098F7CED-404C-1B87-A09C-F5943D72D18A";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "D5D9E01F-0D46-3FD5-043D-A8BBAAB4C238";
...
createNode reference -n "xRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		" -cb 1 -type \"string\" \"face_knowledgegraph_searching\""
		...
		"rotateX" " -av 13.06064536010218013"
		2 "|x:actor_grp|x:ctrl_grp|x:virtual_all_ctrl|x:movement_grp|x:all_subDriver_null|x:virtual_all_sub_ctrl|x:wheel_L_ctrl" 
		"rotateX" " -av -8.84562133979875398"
...
createNode gameFbxExporter -n "gameExporterPreset2";
	...
	setAttr ".ilu" yes;
	setAttr ".eti" 2;
	setAttr ".ac[0].acn" -type "string" "anim_knowledgegraph_searching_01";
	setAttr ".ac[0].ace" 36;
	setAttr ".spt" 2;
	setAttr ".ic" no;
	setAttr ".ebm" yes;
...
createNode animCurveTA -n "mech_head_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr -s 3 ".ktv[0:2]"  0 -35 5 -35 29 -35;
...
createNode animCurveTA -n "wheel_L_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr -s 6 ".ktv[0:5]"  6 0 10 20.472347263955431 20 20.472347263955431
		 25 4.4173418250253658 32 4.4173418250253658 36 -8.845621339798754;
createNode animCurveTA -n "wheel_R_ctrl_rotateX";
	rename -uid "B0FC2C92-044D-2D15-6C57-65A739664F35";
	setAttr ".tan" 18;
	setAttr -s 6 ".ktv[0:5]"  6 0 10 -16.942729576707841 20 -16.942729576707841
		 25 -3.5980605588478549 32 -3.5980605588478549 36 13.06064536010218;
...
createNode animCurveTU -n "AnkiAudioNode_WwiseIdEnum";
	rename -uid "906507EB-1B4B-9709-637E-71B3DA0D61A5";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  0 193;
	setAttr ".kot[0]"  5;
createNode animCurveTU -n "AnkiAudioNode_volume";
	rename -uid "11EF402D-9046-9C78-BBAF-6898481A33B8";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  5 100;
	setAttr ".kot[0]"  5;
createNode animCurveTU -n "AnkiAudioNode_probability";
	rename -uid "B18F3186-9D49-8437-7A18-C9B1AF2002C1";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  5 100;
	setAttr ".kot[0]"  5;
createNode animCurveTU -n "AnkiAudioNode_hasAlts";
	rename -uid "ADCB091E-F944-9BDF-CF41-D98AFEFC19D6";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  5 1;
	setAttr ".kot[0]"  5;
createNode animCurveTU -n "AnkiAudioNode_WwiseIdEnum1";
	rename -uid "64D50DA3-7148-EC7F-FADD-5E913E7401E3";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  5 194;
	setAttr ".kot[0]"  5;
...
// End of anim_knowledgegraph_searching_01.ma
