...
//Name: anim_QA_stub.ma
//Last modified: Sat, Apr 15, 2017 11:24:26 PM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	rename -uid "157A977C-E347-BC08-C566-D0A8A031082E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.057833756136625031 11.227147019953611 -2.9062021399365365 ;
	setAttr ".r" -type "double3" -104.73835272959164 0 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "03A19760-D545-8B57-763D-E69A0380E898";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 5.6951531575844374;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0 6.2702743168643478 -2.6568102099437185 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	rename -uid "5FFF352B-AD45-64B1-F7CF-71B23393F7ED";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 100.1 0 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "1A1FA722-7247-55B8-87DB-10B32670BFF3";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "349921A2-9C46-EC95-28D9-6AB79D6954F8";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 100.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "11466AEC-CD49-88B0-53E4-BD88396144C6";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "1CF0AF74-7444-8197-B838-3C9C0795CB70";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.1 0 0 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "9C1E563E-A846-1B71-5A12-9D8509C4A2FF";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 30;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "C4DB12B5-9F42-3E2A-BA67-8E9055A436C4";
	setAttr -s 16 ".lnk";
	setAttr -s 16 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "7FECF774-2C4C-4B75-E7CA-9B8F798D87E0";
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
createNode displayLayer -n "defaultLayer";
	rename -uid "D3C38FF3-FE44-C3C3-6541-AABB6DA0A549";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "5485E8B4-D84C-44B9-D9B0-7E9087B5AC88";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "BAF14E1F-384D-3212-6112-ACB003AFA824";
	setAttr ".g" yes;
createNode reference -n "xRN";
	rename -uid "F3E11602-DB4C-44F1-BCD9-9A83DF541820";
	setAttr -s 12 ".phl";
	setAttr ".phl[1]" 0;
	setAttr ".phl[2]" 0;
	setAttr ".phl[3]" 0;
...
createNode displayLayer -n "x_geo_lyr";
	rename -uid "9095CD7A-2645-67B5-1A96-F0A437D0F19D";
	setAttr ".dt" 2;
	setAttr ".c" 3;
	setAttr ".do" 1;
createNode script -n "uiConfigurationScriptNode";
	rename -uid "9DEE87A1-3343-4474-BC48-C69CEFC42DA4";
	setAttr ".b" -type "string" "// Maya Mel UI Configuration File.\n// No UI generated in batch mode.\n";
	setAttr ".st" 3;
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "F77271DC-A04A-0F1B-54BE-87828D29827F";
	setAttr ".b" -type "string" "playbackOptions -min 0 -max 150 -ast 0 -aet 250 ";
	setAttr ".st" 6;
createNode animCurveTU -n "backpack_ctrl_frontRed";
	rename -uid "CCF5A7D3-A34A-0D4E-B2B6-6DA2901B37EF";
	setAttr ".tan" 1;
	setAttr ".ktv[0]"  150 1;
	setAttr ".kot[0]"  18;
	setAttr ".kix[0]"  1;
...
createNode animCurveTU -n "backpack_ctrl_frontGreen";
	rename -uid "7BC36FD4-0A45-DC84-6DEE-649CAFC9F3AB";
	setAttr ".tan" 1;
	setAttr ".ktv[0]"  150 1;
	setAttr ".kot[0]"  18;
	setAttr ".kix[0]"  1;
...
createNode animCurveTU -n "backpack_ctrl_frontBlue";
	rename -uid "A04DD33B-4F47-E8EF-1D7D-A5B9EF6BA6A9";
	setAttr ".tan" 1;
	setAttr ".ktv[0]"  150 1;
	setAttr ".kot[0]"  18;
	setAttr ".kix[0]"  1;
...
createNode animCurveTU -n "backpack_ctrl_middleRed";
	rename -uid "F9DF0A68-554C-F144-420C-DEB9ACE29B0E";
	setAttr ".tan" 1;
	setAttr ".ktv[0]"  150 0;
	setAttr ".kot[0]"  18;
	setAttr ".kix[0]"  1;
...
createNode animCurveTU -n "backpack_ctrl_middleGreen";
	rename -uid "0D922C40-2047-E6C0-84E0-56A873161088";
	setAttr ".tan" 1;
	setAttr ".ktv[0]"  150 1;
	setAttr ".kot[0]"  18;
	setAttr ".kix[0]"  1;
...
createNode animCurveTU -n "backpack_ctrl_middleBlue";
	rename -uid "D94CFC96-8C49-C225-2F76-EF8E2CF59047";
	setAttr ".tan" 1;
	setAttr ".ktv[0]"  150 0;
	setAttr ".kot[0]"  18;
	setAttr ".kix[0]"  1;
...
createNode animCurveTU -n "backpack_ctrl_backRed";
	rename -uid "EA35E136-314D-F68B-5DDE-CC9E088B294B";
	setAttr ".tan" 1;
	setAttr ".ktv[0]"  150 1;
	setAttr ".kot[0]"  18;
	setAttr ".kix[0]"  1;
...
createNode animCurveTU -n "backpack_ctrl_backGreen";
	rename -uid "42CC4799-6949-A98C-7B39-98BC85507388";
	setAttr ".tan" 1;
	setAttr ".ktv[0]"  150 0;
	setAttr ".kot[0]"  18;
	setAttr ".kix[0]"  1;
...
createNode animCurveTU -n "backpack_ctrl_backBlue";
	rename -uid "F77C7004-0C4C-EF0B-D6F5-F2A39A0685CD";
	setAttr ".tan" 1;
	setAttr ".ktv[0]"  150 1;
	setAttr ".kot[0]"  18;
	setAttr ".kix[0]"  1;
...
createNode animCurveTU -n "backpack_ctrl_leftBrightness";
	rename -uid "1239784D-BB47-01DF-D685-B9AC1A705AE0";
	setAttr ".tan" 1;
	setAttr ".ktv[0]"  150 1;
	setAttr ".kot[0]"  18;
	setAttr ".kix[0]"  1;
...
createNode animCurveTU -n "backpack_ctrl_rightBrightness";
	rename -uid "14D5A86F-F343-094A-51A0-ECBD752BA8E2";
	setAttr ".tan" 1;
	setAttr ".ktv[0]"  150 1;
	setAttr ".kot[0]"  18;
	setAttr ".kix[0]"  1;
...
createNode gameFbxExporter -n "gameExporterPreset1";
	rename -uid "F5DAE0EA-0D46-13A4-6BC2-55AF80816A86";
	setAttr ".pn" -type "string" "Model Default";
	setAttr ".ils" yes;
	setAttr ".ebm" yes;
createNode gameFbxExporter -n "gameExporterPreset2";
	rename -uid "2E7CEC19-1446-81A9-0CC7-84BE3E47AC5F";
	setAttr ".pn" -type "string" "Anim Default";
	setAttr ".ils" yes;
	setAttr ".ilu" yes;
	setAttr ".eti" 2;
	setAttr ".ac[0].acn" -type "string" "anim_qa_stub";
