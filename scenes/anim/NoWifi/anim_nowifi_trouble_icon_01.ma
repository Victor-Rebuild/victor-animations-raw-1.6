...
//Name: anim_nowifi_trouble_icon_01.ma
//Last modified: Mon, Aug 20, 2018 09:04:01 AM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -12.357807480292308 9.5777264084585845 21.52826548224327 ;
	setAttr ".r" -type "double3" -13.538352729605895 -32.59999999999792 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "BF2446E1-794D-82FE-D529-00ACABBE5685";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 26.203722522361161;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "E1FF52C6-1648-4AF2-DA47-B8803AD86E84";
	setAttr -s 130 ".lnk";
	setAttr -s 130 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "78A87078-984C-5EC8-C4BE-9BB028460E10";
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
createNode displayLayer -n "defaultLayer";
	rename -uid "3D283DF4-4D45-D70F-6CB8-DA984144A89B";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "3C1239DB-2241-6A55-A26F-1B9C2EADF6E8";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "257B7A08-8947-928E-55EF-88A081C385C3";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "F29411F8-9C45-03C8-7DC4-CBA77FC36BC5";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "59B46EBB-F14E-83E3-B998-138C0A1FDCC0";
...
createNode gameFbxExporter -n "gameExporterPreset2";
	...
	setAttr ".ilu" yes;
	setAttr ".eti" 2;
	setAttr ".ac[0].acn" -type "string" "anim_nowifi_trouble_icon_01";
...
createNode reference -n "xRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		" -cb 1 -type \"string\" \"face_nowifi_trouble_icon\""
...
createNode animCurveTU -n "mech_eye_R_ctrl_GlowSize";
	...
	setAttr -s 13 ".ktv[0:12]"  0 0 3 0.127413 5 0.12996750000000001 7 0.13
		 8 0.13 85 0.13 87 0.13 88 0.13 90 0.17084326399999999 93 0.35922348533333426 96 0.47721214400000012
		 101 0.5 105 0.5;
	setAttr -s 13 ".ktl[0:12]" no yes yes yes yes yes yes yes yes yes yes 
		yes yes;
...
createNode animCurveTA -n "mech_head_ctrl_rotateX";
	...
	setAttr -s 17 ".ktv[0:16]"  0 -12.109309915681681 3 -12.109309915681681
		 ...
		 35 -24.125432630027543 37 -11.757878631243743 40 -24.125432630027543 85 -24.125432630027543
		 88 20 91 20 97 -9.7693976528325805 100 0 105 0;
	...
	setAttr -s 17 ".kix[0:16]"  0.1333333333333333 0.10972653558335434 
		...
		1.7000000000000006 0.099999999999999645 0.10000000000000009 0.20000000000000018 0.10000000000000009 
		0.16666666666666652;
	...
	setAttr -s 17 ".kox[0:16]"  0.082404531833319306 0.06781472845828776 
		...
		0.39999999999999991 0.066666666666666652 0.099999999999999867 1.5000000000000002 
		0.10000000000000009 0.10000000000000009 0.20000000000000018 0.10000000000000009 0.16666666666666652 
		0.16666666666666652;
...
createNode animCurveTA -n "wheel_L_ctrl_rotateX";
	...
	setAttr -s 14 ".ktv[0:13]"  0 0 3 0 8 0 10 -18.265604699935096 17 70.611687930892657
		 ...
		 87 65.513011451792991 89 65.513011451792991 94 6.8934514690634527 96 2.2409117077910992
		 105 2.2409117077910992;
	...
	setAttr -s 14 ".kix[0:13]"  0.13333333333333333 0.12920176259382907 
		...
		0.36666666666666681 0.1333333333333333 0.10000000000000009 1.6579912485564341 0.066666666666666874 
		0.16666666666666652 0.066666666666666874 0.29999999999999982;
	...
	setAttr -s 14 ".kox[0:13]"  0.059154609772796615 0.16201648303982427 
		...
		0.099999999999999867 0.10047349976229003 1.5999999999999999 0.06666666666666643 0.16666666666666652 
		0.066666666666666874 0.29999999999999982 0.29999999999999982;
...
createNode animCurveTA -n "wheel_R_ctrl_rotateX";
	...
	setAttr -s 14 ".kix[0:13]"  0.13333333333333333 0.11783676799762559 
		...
		0.43333333333333346 0.1333333333333333 0.10000000000000009 1.5909320343692626 0.06666666666666643 
		0.16666666666666696 0.06666666666666643 0.3666666666666667;
	setAttr -s 14 ".kiy[0:13]"  0 0 0 -0.31879494188161833 1.5512013866664374 
		0.12899747359410352 0 -0.40900486416713061 0.39252730567181859 0 0 -1.0231043277689407 
		-0.081202137414153525 0;
	setAttr -s 14 ".kox[0:13]"  0.071767151091808132 0.10108747279118682 
		...
		0.099999999999999867 0.10051361538519021 1.5333333333333334 0.066666666666666874 
...
createNode animCurveTU -n "AnkiAudioNode_volume";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  4 100 11 100 19 100 48 100 84 100 90 100;
...
createNode animCurveTU -n "AnkiAudioNode_WwiseIdEnum2";
	rename -uid "86DB4EE6-BE43-5973-B040-A2B7F32FA142";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  4 177 11 265 19 375 48 266 84 267 90 151;
	setAttr -s 6 ".kot[0:5]"  5 5 5 5 5 5;
select -ne :time1;
	setAttr -av -k on ".cch";
...
// End of anim_nowifi_trouble_icon_01.ma
